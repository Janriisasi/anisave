      ...
      <div> {}
        ...
        <div className="content">
          ...
          <div className="terms-container">
            ...
            <h2>User must not:</h2>
            <ul>
              <li>must not provide false information.</li>
              <li>Engaging in fraudulent transactions</li>
            </ul>

            <h2>4. Liability & Disclaimers</h2>
            <p>anisave operates as a price monitoring service and does not guarantee the quality or accuracy of products listed. We are not responsible
                 for any financial losses, damages, or inconveniences resulting from transactions made based on
                 the information provided. Users are encouraged to verify details and exercise their own judgment before making purchasing decisions.</p>
